...
registry pattern, and three flagship families built fully end-to-end (Guide +
...
catalogue (`/products/*`). The remaining three flagship families are seeded
