...
const STEPS: Step[] = [
  {
    key: "interviewCount",
    legend: "How many people have you talked to about this?",
    options: [
  ...
  {
    key: "questionStyle",
    legend: "Honestly, how open were your questions?",
    hint: "Leading questions — describing your idea first, or asking \"would you use this\" — invalidate the rest of the evidence, whatever else you heard.",
    options: [
      {
  ...
  {
    key: "evidenceType",
    legend: "What kind of evidence did you actually hear?",
    options: [
      {
  ...
  },
  {
    ...
    legend: "Has anyone shown a costly commitment to solving this?",
    hint: "Money spent, time invested, or a workaround they've actually built — not just interest.",
    options: [
  ...
  },
  {
    ...
    legend: "How consistent is what you're hearing across interviews?",
    options: [
...
export function CustomerDiscoveryKitRunner() {
    ...
    return (
      <div className="rounded-md border border-ink-200 bg-paper-raised p-6">
        ...
        <ul className="mt-3 list-disc space-y-1 pl-5 text-sm text-ink-700">
          <li>Takes about 5–10 minutes — answer honestly about interviews you&apos;ve already run.</li>
          <li>Nothing is saved or sent anywhere — this runs entirely in your browser.</li>
          <li>You&apos;ll get an evidence-strength score, a bias-risk flag, and one concrete next action.</li>
        </ul>
        <button
          type="button"
  ...
  if (state.phase === "result") {
    return <CustomerDiscoveryKitResultSummary result={state.result} onRestart={() => dispatch({ type: "restart" })} headingRef={resultHeadingRef} />;
  }
