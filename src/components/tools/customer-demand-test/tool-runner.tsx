...
const STEPS: Step[] = [
  {
    key: "explainability",
    legend: "Is your idea easy to explain in words, or does it need a demo to click?",
    options: [
  ...
  },
  {
    ...
    legend: "Could you fulfil this manually, behind the scenes, for a handful of real users?",
    options: [
  ...
  },
  {
    ...
    legend: "Is there an existing platform your target customers already use?",
    options: [
  ...
  {
    key: "reachNeeded",
    legend: "How many people do you need to reach for a meaningful signal?",
    hint: "Think about what would actually convince you, not what would be nice to have.",
    options: [
...
export function CustomerDemandTestRunner() {
    ...
    return (
      <div className="rounded-md border border-ink-200 bg-paper-raised p-6">
        ...
        <ul className="mt-3 list-disc space-y-1 pl-5 text-sm text-ink-700">
          <li>Takes about 3 minutes — answer based on your idea as it actually stands today.</li>
          <li>Nothing is saved or sent anywhere — this runs entirely in your browser.</li>
          <li>You&apos;ll get a recommended demand test, a runner-up, and one concrete next step.</li>
        </ul>
        <button
          type="button"
  ...
  if (state.phase === "result") {
    return (
      <CustomerDemandTestResultSummary result={state.result} onRestart={() => dispatch({ type: "restart" })} headingRef={resultHeadingRef} />
    );
  }
