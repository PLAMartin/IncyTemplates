...
export const getFrameworks = catalogueSource.getFrameworks.bind(catalogueSource);
export const getFrameworkTeasers = catalogueSource.getFrameworkTeasers.bind(catalogueSource);
export const getFrameworkBySlug = catalogueSource.getFrameworkBySlug.bind(catalogueSource);
